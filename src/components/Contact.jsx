...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send('service_rf9rrlw'
      ,'template_4gousju',
      
      {
        from_name: form.name,
        to_name: "Allama Nesrine",
        from_email: form.email,
        to_email: "allamanesrine@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Merci. Je reviendrai vers toi dès que possible.");
        ...
        (error) => {
          ...
          alert("Ahh, quelque chose s'est mal passé. Veuillez réessayer, s'il vous plaît.");
        }
      );
  };
